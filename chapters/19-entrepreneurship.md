...
**Project:** Build a Fictional Company (Founder Mode) — final probe and integration.
**What you're building this chapter:** the business model canvas, the effectuation-vs-causation decisions, the founder-transition plan, and the compiled operating handbook.
**Tool:** **Claude Project** "Founder Handbook" — produces the final compiled handbook. **Cowork** is the right tool for assembling the 19 sections into one master document.
...
```
I'm in chapter 19 — the closing chapter — of building my fictional
company. All eighteen prior sections are in this project. This
chapter covered: entrepreneurship as opportunity recognition +
new-venture creation; effectuation logic (Sarasvathy — start with
the means at hand and pursue goals that emerge) vs. causation logic
(start with the goal and acquire the means to reach it); the
business-model canvas (customer segments, value prop, channels,
relationships, revenue, resources, activities, partners, costs);
founder transitions (from "I do everything" → "I do critical few"
→ "I lead leaders" → "I am replaceable"); the closing question of
the whole book: what is management when there is no organization
yet?

The chapter's strongest practical claim: most founder failures are
not from missing the market, missing the product, or missing the
team — they're from refusing to make the transitions the
organization needs as it grows.

Write the "Founding Synthesis and Forward Plan" section of the
operating handbook. This is the project's closer. Cover five things.

1. **The business model canvas.** Fill out all nine blocks
   specifically for this company. Don't generalize. Names, numbers,
   specifics.

2. **The effectuation vs. causation choices.** Across the eighteen
   prior sections of the handbook, where has the founder chosen
   effectuation (work with current means; pivot as opportunities
   emerge) and where has the founder chosen causation (set the
   target and acquire what's needed)? Name three of each. Then:
   for the next 12 months, which decisions will follow which
   logic, and why?

3. **The founder-transition plan.** Specify:
   - The "I do critical few" transition (typically month 12–18):
     what 5 things the founder commits to doing personally, and
     what stops being on the founder's plate. The honest answer
     about what the founder will resist letting go.
   - The "I lead leaders" transition (typically month 18–30): the
     first management-of-managers move. What changes about the
     founder's calendar, their meetings, their decisions.
   - The "I am replaceable" transition (typically month 30+): the
     succession-readiness move. What the founder must accept,
     even if they don't intend to leave.

4. **The book-as-system honest reading.** Look back across the 18
   chapter-handbook sections. Name:
   - The three sections that are most likely to be ACTUALLY
     followed at this company.
   - The three most likely to drift into aspiration without
     practice.
   - The single biggest contradiction between two sections (most
     handbooks have at least one — Chapter 4's reinforcement
     architecture quietly fighting Chapter 7's motivation
     philosophy, for instance).
   - The one section that, if the founder followed nothing else,
     would have the biggest single effect on the company.

5. **The closing question.** The chapter asked: what is management
   when there is no organization yet? Answer specifically for THIS
   founder, this company, this moment. The answer should be 100
   words, not a paragraph of management aphorisms.

End with a 250-word "Forward" — a forward-looking commitment, not a
retrospective. Three things specifically: (a) what this handbook
will be reviewed against at day 100 of operations, (b) what would
trigger a major handbook revision (specific events, not "if
something changes"), (c) the one thing the founder is most
uncertain about in this handbook — name it honestly.

Then output a final 200-word section titled "Operating Handbook —
v1.0 — [Company Name]" that introduces the compiled handbook to a
future reader (a co-founder, an early employee, a future the-
founder themselves at month 18). It should answer: what is this
document, what isn't it, how should it be used, when should it be
revised.

After producing this section, ask me whether to compile the full
operating handbook by assembling all 19 sections. If yes, the
assembly should be ordered by chapter, include a clean table of
contents, and produce a single ~12,000–18,000 word document.
```

---

**What this produces:** A ~1,500-word "Founding Synthesis and Forward Plan" section — the project's closer. The business model canvas is operationally useful. The founder-transition plan is the discipline most founder-handbooks lack. The book-as-system honest reading is the methodological reckoning. The "Forward" commits to a real day-100 review.

When the student says "yes, compile" — the assembly produces the actual operating handbook, the project's final deliverable.

**How to adapt this prompt:**

- *For your own project:* The business model canvas varies enormously by industry. A clinic, a SaaS company, an agency, a nonprofit all have very different canvas shapes. Spend time here.
- *For ChatGPT / Gemini:* Works as written.
- *For Claude Code:* The compilation step is where Claude Code earns its keep — reading 19 markdown sections, assembling a master document with TOC, and outputting a clean .md (or .docx via pandoc).
- *For a Claude Project:* The full operating handbook is the project's deliverable. It should live as a long markdown file in the Project, with the eighteen prior sections as references.

**Connection to previous chapters:** Every prior chapter feeds this one. The "honest reading" section (point 4 above) explicitly looks back across the eighteen-section handbook and names where the design works and where it contradicts itself.
